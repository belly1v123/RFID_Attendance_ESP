...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.roleDo.UseModel(&tenant.Role{})
...
type IRoleDo interface {
	...
	Unscoped() IRoleDo
	Create(values ...*tenant.Role) error
	CreateInBatches(values []*tenant.Role, batchSize int) error
	Save(values ...*tenant.Role) error
	First() (*tenant.Role, error)
	Take() (*tenant.Role, error)
	Last() (*tenant.Role, error)
	Find() ([]*tenant.Role, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Role, err error)
	FindInBatches(result *[]*tenant.Role, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*tenant.Role) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*tenant.Role, error)
	FirstOrCreate() (*tenant.Role, error)
	FindByPage(offset int, limit int) (result []*tenant.Role, count int64, err error)
...
func (r roleDo) Create(values ...*tenant.Role) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roleDo) CreateInBatches(values []*tenant.Role, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r roleDo) Save(values ...*tenant.Role) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roleDo) First() (*tenant.Role, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*tenant.Role), nil
	}
}

func (r roleDo) Take() (*tenant.Role, error) {
...
func (r roleDo) Last() (*tenant.Role, error) {
...
func (r roleDo) Find() ([]*tenant.Role, error) {
	result, err := r.DO.Find()
	return result.([]*tenant.Role), err
}

func (r roleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Role, err error) {
	buf := make([]*tenant.Role, 0, batchSize)
...
func (r roleDo) FindInBatches(result *[]*tenant.Role, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r roleDo) FirstOrInit() (*tenant.Role, error) {
...
func (r roleDo) FirstOrCreate() (*tenant.Role, error) {
...
func (r roleDo) FindByPage(offset int, limit int) (result []*tenant.Role, count int64, err error) {
...
func (r roleDo) Delete(models ...*tenant.Role) (result gen.ResultInfo, err error) {

...
func newShift(db *gorm.DB, opts ...gen.DOOption) shift {
	...
	_shift.shiftDo.UseModel(&tenant.Shift{})

	tableName := _shift.shiftDo.TableName()
	_shift.ALL = field.NewAsterisk(tableName)
	_shift.ID = field.NewUint(tableName, "id")
	_shift.Name = field.NewString(tableName, "name")
	_shift.StartTime = field.NewString(tableName, "start_time")
	_shift.EndTime = field.NewString(tableName, "end_time")
...
type IShiftDo interface {
	...
	Unscoped() IShiftDo
	Create(values ...*tenant.Shift) error
	CreateInBatches(values []*tenant.Shift, batchSize int) error
	Save(values ...*tenant.Shift) error
	First() (*tenant.Shift, error)
	Take() (*tenant.Shift, error)
	Last() (*tenant.Shift, error)
	Find() ([]*tenant.Shift, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Shift, err error)
	FindInBatches(result *[]*tenant.Shift, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*tenant.Shift) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*tenant.Shift, error)
	FirstOrCreate() (*tenant.Shift, error)
	FindByPage(offset int, limit int) (result []*tenant.Shift, count int64, err error)
...
func (s shiftDo) Create(values ...*tenant.Shift) error {
	if len(values) == 0 {
		return nil
	}
...
func (s shiftDo) CreateInBatches(values []*tenant.Shift, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s shiftDo) Save(values ...*tenant.Shift) error {
	if len(values) == 0 {
		return nil
	}
...
func (s shiftDo) First() (*tenant.Shift, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*tenant.Shift), nil
	}
}

func (s shiftDo) Take() (*tenant.Shift, error) {
...
func (s shiftDo) Last() (*tenant.Shift, error) {
...
func (s shiftDo) Find() ([]*tenant.Shift, error) {
	result, err := s.DO.Find()
	return result.([]*tenant.Shift), err
}

func (s shiftDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Shift, err error) {
	buf := make([]*tenant.Shift, 0, batchSize)
...
func (s shiftDo) FindInBatches(result *[]*tenant.Shift, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s shiftDo) FirstOrInit() (*tenant.Shift, error) {
...
func (s shiftDo) FirstOrCreate() (*tenant.Shift, error) {
...
func (s shiftDo) FindByPage(offset int, limit int) (result []*tenant.Shift, count int64, err error) {
...
func (s shiftDo) Delete(models ...*tenant.Shift) (result gen.ResultInfo, err error) {

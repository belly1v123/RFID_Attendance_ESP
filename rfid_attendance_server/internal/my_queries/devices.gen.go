...
func newDevice(db *gorm.DB, opts ...gen.DOOption) device {
	...
	_device.deviceDo.UseModel(&tenant.Device{})
...
type IDeviceDo interface {
	...
	Unscoped() IDeviceDo
	Create(values ...*tenant.Device) error
	CreateInBatches(values []*tenant.Device, batchSize int) error
	Save(values ...*tenant.Device) error
	First() (*tenant.Device, error)
	Take() (*tenant.Device, error)
	Last() (*tenant.Device, error)
	Find() ([]*tenant.Device, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Device, err error)
	FindInBatches(result *[]*tenant.Device, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*tenant.Device) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*tenant.Device, error)
	FirstOrCreate() (*tenant.Device, error)
	FindByPage(offset int, limit int) (result []*tenant.Device, count int64, err error)
...
func (d deviceDo) Create(values ...*tenant.Device) error {
	if len(values) == 0 {
		return nil
	}
...
func (d deviceDo) CreateInBatches(values []*tenant.Device, batchSize int) error {
	return d.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (d deviceDo) Save(values ...*tenant.Device) error {
	if len(values) == 0 {
		return nil
	}
...
func (d deviceDo) First() (*tenant.Device, error) {
	if result, err := d.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*tenant.Device), nil
	}
}

func (d deviceDo) Take() (*tenant.Device, error) {
...
func (d deviceDo) Last() (*tenant.Device, error) {
...
func (d deviceDo) Find() ([]*tenant.Device, error) {
	result, err := d.DO.Find()
	return result.([]*tenant.Device), err
}

func (d deviceDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Device, err error) {
	buf := make([]*tenant.Device, 0, batchSize)
...
func (d deviceDo) FindInBatches(result *[]*tenant.Device, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (d deviceDo) FirstOrInit() (*tenant.Device, error) {
...
func (d deviceDo) FirstOrCreate() (*tenant.Device, error) {
...
func (d deviceDo) FindByPage(offset int, limit int) (result []*tenant.Device, count int64, err error) {
...
func (d deviceDo) Delete(models ...*tenant.Device) (result gen.ResultInfo, err error) {

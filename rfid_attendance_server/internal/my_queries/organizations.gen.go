...
func newOrganization(db *gorm.DB, opts ...gen.DOOption) organization {
	...
	_organization.organizationDo.UseModel(&public.Organization{})
	...
	_organization.Schema = field.NewString(tableName, "schema")
...
type IOrganizationDo interface {
	...
	Create(values ...*public.Organization) error
	CreateInBatches(values []*public.Organization, batchSize int) error
	Save(values ...*public.Organization) error
	First() (*public.Organization, error)
	Take() (*public.Organization, error)
	Last() (*public.Organization, error)
	Find() ([]*public.Organization, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*public.Organization, err error)
	FindInBatches(result *[]*public.Organization, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*public.Organization) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*public.Organization, error)
	FirstOrCreate() (*public.Organization, error)
	FindByPage(offset int, limit int) (result []*public.Organization, count int64, err error)
...
func (o organizationDo) Create(values ...*public.Organization) error {
	if len(values) == 0 {
		return nil
	}
...
func (o organizationDo) CreateInBatches(values []*public.Organization, batchSize int) error {
	return o.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (o organizationDo) Save(values ...*public.Organization) error {
	if len(values) == 0 {
		return nil
	}
...
func (o organizationDo) First() (*public.Organization, error) {
	if result, err := o.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*public.Organization), nil
	}
}

func (o organizationDo) Take() (*public.Organization, error) {
...
func (o organizationDo) Last() (*public.Organization, error) {
...
func (o organizationDo) Find() ([]*public.Organization, error) {
	result, err := o.DO.Find()
	return result.([]*public.Organization), err
}

func (o organizationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*public.Organization, err error) {
	buf := make([]*public.Organization, 0, batchSize)
...
func (o organizationDo) FindInBatches(result *[]*public.Organization, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (o organizationDo) FirstOrInit() (*public.Organization, error) {
...
func (o organizationDo) FirstOrCreate() (*public.Organization, error) {
...
func (o organizationDo) FindByPage(offset int, limit int) (result []*public.Organization, count int64, err error) {
...
func (o organizationDo) Delete(models ...*public.Organization) (result gen.ResultInfo, err error) {
